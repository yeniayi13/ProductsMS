...
namespace ProductsMS.Test.Infrastructure.RabbitMQ
{
    public class RabbitMQProducerTests
    {
        ...
        private readonly RabbitMQProducer<GetProductDto> _producer;
        ...
        public RabbitMQProducerTests()
        {
            ...
            _producer = new RabbitMQProducer<GetProductDto>(_mockRabbitMQConnection.Object);
        }
        ...
        public async Task PublishMessageAsync_ShouldDeclareQueue_AndPublishMessage()
        {
            ...
            var testProduct = new GetProductDto { ProductId = Guid.NewGuid(), ProductName = "Test Product" };
        ...
        public async Task PublishMessageAsync_ShouldThrowException_WhenMessageIsNull()
        {
            var queueName = "testQueue";
            var eventType = "PRODUCT_CREATED";
            GetProductDto testProduct = null; // 🔥 Simular mensaje nulo
        ...
        public async Task PublishMessageAsync_ShouldSupportDifferentEventTypes()
        {
            ...
            var testProduct = new GetProductDto { ProductId = Guid.NewGuid(), ProductName = "Updated Product" };
